 ...
 * @since 1.3
 */
public class AIPaymentRequiredException extends AIHttpException {

    private static final long serialVersionUID = 1L;

    /** The HTTP status code for Payment Required: {@value}. */
    public static final int STATUS_CODE = 402;

    /**
     * Constructs a new payment required exception with the specified HTTP request URI and HTTP response body.
     *
