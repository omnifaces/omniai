 ...
 * </ul>
 * <p>
 * This differs from {@link AIHttpException} which represents HTTP-level errors (4xx/5xx status codes). {@code AIResponseException} is thrown when the HTTP
 * request succeeded but the response content is unusable.
 *
