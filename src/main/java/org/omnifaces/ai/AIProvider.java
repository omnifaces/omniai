...
public enum AIProvider {
    ...
    /**
     * Custom: provide the {@link Class} instance of your custom {@link AIService} implementation as the provider in {@link AIConfig}, or use
     * {@link AI#serviceClass()} when using CDI injection.
     * <p>
     * Custom providers that extend {@link org.omnifaces.ai.service.BaseAIService} must supply their handlers via {@link AIConfig#withStrategy(AIStrategy)} or
     * {@link AI#textHandler()}, {@link AI#imageHandler()} and {@link AI#audioHandler()}, since this provider has no default handlers.
     * <p>
