...
public enum AIProvider {
     ...
     */
    OPENROUTER("OpenRouter", OpenRouterAIService.class, true, "deepseek/deepseek-v3.2", "https://openrouter.ai/api/v1", OpenAITextHandler.class, OpenAIImageHandler.class),
