...
@EnabledIfEnvironmentVariable(named = HuggingFaceAIServiceTextHandlerIT.API_KEY_ENV_NAME, matches = ".+")
class HuggingFaceAIServiceTextHandlerIT extends BaseAIServiceTextHandlerIT {
