...
@EnabledIfEnvironmentVariable(named = HuggingFaceAIServiceImageHandlerIT.API_KEY_ENV_NAME, matches = ".+")
class HuggingFaceAIServiceImageHandlerIT extends BaseAIServiceImageHandlerIT {
