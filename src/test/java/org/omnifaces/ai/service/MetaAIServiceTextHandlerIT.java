...
@EnabledIfEnvironmentVariable(named = MetaAIServiceTextHandlerIT.API_KEY_ENV_NAME, matches = ".+")
class MetaAIServiceTextHandlerIT extends BaseAIServiceTextHandlerIT {
